...
class NewspaperCropClassifier:
    def __init__(self, model_path="Current_Classifier_In_Production.pt"):
...
CLASSIFIER_MODEL_PATH = r"C:\Article-Detection\Classifier_models\Current_Classifier_In_Production.pt"
                ...
                if classifier_result:
                    ...
                    if classifier_result['confidence'] < 85:
                       ...
                       # if YOLO is wrong and high confidence, listen to classifier (now Ollama)
                            ...
                            # MOVE
                            new_crop_path = move_corrected_image(crop_path, destination_folder, f"{old_class}_By_Ollama")
                        ...
                        # if YOLO is wrong and high confidence, listen to classifier
                            ...
                            destination_folder = os.path.join(folder_to_check, new_class)
                            # MOVE
                            new_crop_path = move_corrected_image(crop_path, destination_folder, f"{old_class}_By_Classifier")
