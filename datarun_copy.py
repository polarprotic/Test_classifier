...
class NewspaperCropClassifier:
    def __init__(self, model_path="newspaper_classifier_3_best_again.pt"):
...
def main(newspaper_img):
    ...
    try:
        ...
        classifier = NewspaperCropClassifier(model_path="newspaper_classifier_3_best_again.pt")
        ...
        for item in items:
            ...
            if class_id_of_low_conf_image != 3:              # not for Extras folder right now
                ...
                if classifier_result:
                    ...
                    if classifier_result['confidence'] < 82:
                        print("Call Ollama")
                    else:
                        ...
                        # if YOLO is wrong and high confidence, listen to classifier
                            ...
                            # MOVE
                            new_crop_path = move_corrected_image(crop_path, destination_folder, old_class)
